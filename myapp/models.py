...
class UserProfile(models.Model):
    user = models.OneToOneField('myapp.User', on_delete=models.CASCADE)
...
class Client(models.Model):
    ...
    user = models.OneToOneField('myapp.User', on_delete=models.SET_NULL, null=True, blank=True)
    name = models.CharField(max_length=255)
...
class Matter(models.Model):
    ...
    assigned_to = models.ManyToManyField('myapp.User', blank=True)
    def __str__(self): return self.title

class Document(models.Model):
    matter = models.ForeignKey(Matter, on_delete=models.CASCADE, related_name='documents')
    uploaded_by = models.ForeignKey('myapp.User', on_delete=models.SET_NULL, null=True)
...
class TimeEntry(models.Model):
    ...
    user = models.ForeignKey('myapp.User', on_delete=models.SET_NULL, null=True)
...
class Task(models.Model):
    ...
    title = models.CharField(max_length=255)
    description = models.TextField(blank=True)
    assigned_to = models.ForeignKey('myapp.User', on_delete=models.SET_NULL, null=True, blank=True)
...
class Event(models.Model):
    ...
    participants = models.ManyToManyField('myapp.User', blank=True)

class Message(models.Model):
    matter = models.ForeignKey(Matter, on_delete=models.CASCADE, related_name='messages')
    sender = models.ForeignKey('myapp.User', on_delete=models.SET_NULL, null=True)
    text = models.TextField()
    created_at = models.DateTimeField(auto_now_add=True)
